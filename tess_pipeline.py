        ...
        for subdir, dirs, files in os.walk(path):
            for filename in files:
                if filename.startswith('OAF'):
                    destination_path = 'D:\Speech_Emotion_Recognition\Project\features' + 'Actor_26//'
                    ...
                    destination_path = 'D:\Speech_Emotion_Recognition\Project\features' + 'Actor_25\\'
                    old_file_path = os.path.join(os.path.abspath(subdir), filename)
...
if __name__ == '__main__':
    TESSPipeline.create_tess_folders('D:\Speech_Emotion_Recognition\Project\TESS Toronto emotional speech set data')
