...
if __name__ == '__main__':
    ...
    FEATURES = CreateFeatures.features_creator(path='D:\Speech_Emotion_Recognition\Project\features', save_dir='D:\Speech_Emotion_Recognition\Project\Speech_Emotion_Recognition')
